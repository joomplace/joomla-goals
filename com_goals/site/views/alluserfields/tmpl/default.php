...
<script type="text/javascript">
 ...
 <div class="gl_goals">
 		<h2><?php echo JText::_('COM_GOALS_MY_FIELDS'); ?>:</h2>
 		<?php
 	if ($user->authorise('core.create', 'com_goals')){
 		?>
 		<p class="goals-actions"><a href="<?php echo JRoute::_('index.php?option=com_goals&view=edituserfield'.$tmpl);?>" class="btn" ><?php echo JText::_('COM_GOALS_FIELDS_NEW_FIELD') ?></a></p>
     ...
     <div class="gl_goals">
         ...
         echo $this->loadTemplate('planflds'); ?>
     </div>
