...
<div class="gl_dashboard">
    ...
    <div class="gl_goals">
        ...
        <div class="control-group"><?php showJbField($this->form,'type'); ?></div>
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <input type="button" class="btn" onclick="Joomla.submitbutton('planuserfield.save')" value="<?php echo JText::_('JSAVE') ?>" />
                            <input type="button" class="btn" onclick="Joomla.submitbutton('planuserfield.cancel')" value="<?php echo JText::_('JCANCEL') ?>" />
                        </div>
                    </div>
    </div>
	<input type="hidden" name="task" value="planuserfield.edit" />
	<input type="hidden" name="id" value="<?php echo ($old)?$this->item->id:0; ?>" />
	<input type="hidden" name="pid" value="<?php echo (JRequest::getInt('pid'))?JRequest::getInt('pid'):0; ?>" />
