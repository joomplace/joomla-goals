                            ...
                            <div class="goals-edit-item">
                                ...
                                <div class="btn-group">
                                    ...
                                    <button class="btn"
                                            ...
                                            onclick="goalgoto('<?php echo JRoute::_('index.php?option=com_goals&view=edithabit&id=' . (int)$habit->id . $tmpl);?>')"><?php echo JText::_('COM_GOAL_HABIT_EDITBUTTON'); ?></button>
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="javascript:void(0)"
                                               ...
                                               onclick="goalgoto('<?php echo JRoute::_('index.php?option=com_goals&task=habit.featuredOnOff&id=' . $habit->id); ?>')"><?php echo JText::_('COM_GOAL_GOAL_REMOVE_FROM_FEATURED'); ?></a>
