...
<div id="goals-wrap">
    ...
    <div class="goals-content">
        <h2><?php echo JText::_('COM_GOALS_SELECT_TEMPLATE_FOR_PLAN'); ?>:</h2>
            ...
            ?>
				<div class="row-fluid" style="padding-bottom: 20px">
					<div class="span2">
						 <a href="<?php echo JRoute::_('index.php?option=com_goals&view=editplan&tempid='.$template->id); ?>"><img style="max-width:100%;" src="<?php echo $template->image; ?>" title="<?php echo $template->title; ?>"/></a>
					</div>
					<div class="span10">
						<h5>
							 <a href="<?php echo JRoute::_('index.php?option=com_goals&view=editplan&tempid='.$template->id); ?>"><?php echo $template->title; ?></a>
						</h5>
