...
class GoalsControllerPlanUserfield extends JControllerForm
{

	 public function getModel($name = 'Editplanuserfield', $prefix = 'GoalsModel', $config = array('ignore_request' => true))
	{
		if (empty($name)) {
			$name = $this->context;
		}
	...
	function delete()
	{
	 ...
	 function cancel($key = null)
	 {
	 	...
	 	$tmpl = JRequest::getVar('tmpl'); if ($tmpl=='component') $tmpl='&tmpl=component'; else $tmpl='';
	 	$url =  JRoute::_('index.php?option=com_goals&view=planuserfields'.$tmpl, false);
