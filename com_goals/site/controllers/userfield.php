...
class GoalsControllerUserfield extends JControllerForm
{

	 public function getModel($name = 'Edituserfield', $prefix = 'GoalsModel', $config = array('ignore_request' => true))
	{
		if (empty($name)) {
			$name = $this->context;
		}
	...
	function deletelog()
	{
	 ...
	 function cancel()
	 {
	 	...
	 	$tmpl = JRequest::getVar('tmpl'); if ($tmpl=='component') $tmpl='&tmpl=component'; else $tmpl='';
	 	$url =  JRoute::_('index.php?option=com_goals&view=userfields'.$tmpl,false);
