...
class JFormFieldplanimage extends JFormField
{
	public $type = 'planimage';
	...
	protected function getInput()
	{
		...
		<div>
			<span title="<?php echo JText::_('COM_GOALS_UPLOAD')?>::<small>&nbsp;* Select gif, jpg, png files</small>" class="hasTip">
            	<a class="popup btn" href="<?php echo "index.php?option=com_goals&amp;task=plan.upload&tmpl=component"?>" rel="{handler: 'iframe', size: {x: 300, y: 150}}">
