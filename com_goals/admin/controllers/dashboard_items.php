...
class GoalsControllerDashboard_items extends JControllerAdmin
{
	...
	public function getModel($name = 'Dashboard_items', $prefix = 'GoalsModel')
	{
	...
	public function add()
	{
		$this->setRedirect('index.php?option=com_goals&task=dashboard_item.add');
	}
