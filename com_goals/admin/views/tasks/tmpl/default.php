...
<form action="<?php echo JRoute::_('index.php?option=com_goals&view=tasks'); ?>" method="post" name="adminForm" id="adminForm">
				...
				<table class="table table-striped">
						<thead>
							<tr>
								...
								<th class="gl_left">
									<?php echo JHtml::_('grid.sort', 'COM_GOALS_TASK_SELECT', 'gtitle', $listDirn, $listOrder); ?>							
								</th>
						...
						<tbody>
						<?php if (sizeof($this->tasks)) {foreach($this->tasks as $i => $item) {
							?>
							<tr class="row<?php echo $i % 2; ?>">
								...
								<?php if ($this->canDo->get('core.edit') or ($this->canDo->get('core.edit.own') and $item->user_id == $this->user->get('id'))) { ?>
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=task.edit&id='.$item->id);?>">
						...
						<?php }} else { ?>
							<tr>
								<td colspan="9" align="center" >
									...
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=task.add'); ?>" >
