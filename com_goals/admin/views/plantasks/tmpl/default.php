				...
				<table class="table table-striped">
						<thead>
							<tr>
								...
								<th width="20%">
									<?php echo JHtml::_('grid.sort', 'COM_GOALS_TASK_DUEDATE', 'date', $listDirn, $listOrder); ?>
								</th>
								<th class="gl_left">
						...
						<?php if (sizeof($this->plantasks)) {foreach($this->plantasks as $i => $item) {
							...
							<tr class="row<?php echo $i % 2; ?>">
								...
								<?php if ($this->canDo->get('core.edit') or ($this->canDo->get('core.edit.own') and $item->user_id == $this->user->get('id'))) { ?>
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=plantask.edit&id='.$item->id);?>">
						...
						<?php }} else { ?>
							<tr>
								<td colspan="9" align="center" >
									<?php echo JText::sprintf('COM_GOALS_FIELD_NONE', 'tasks'); ?>
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=plantask.add'); ?>" >
