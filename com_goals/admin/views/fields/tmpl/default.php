...
<form action="<?php echo JRoute::_('index.php?option=com_goals&view=fields'); ?>" method="post" name="adminForm" id="adminForm">
						...
						<?php if (sizeof($this->fields)) {foreach($this->fields as $i => $item) {
							...
							<tr class="row<?php echo $i % 2; ?>">
								...
								<?php if ($this->canDo->get('core.edit') or ($this->canDo->get('core.edit.own') and $item->user_id == $this->user->get('id'))) { ?>
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=field.edit&id='.$item->id);?>">
						...
						<?php }} else { ?>
							<tr>
								<td colspan="9" align="center" >
									<?php echo JText::sprintf('COM_GOALS_FIELD_NONE', 'custom fields'); ?>
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=field.add'); ?>" >
