				...
				<table class="table table-striped">
						<thead>
							<tr>
                                ...
                                <th class="gl_left">
                                    <?php echo JHtml::_('grid.sort', 'COM_GOALS_CREATOR', 'uid', $listDirn, $listOrder); ?>
                                </th>
								<th class="gl_left">
						...
						<?php if (sizeof($this->goals)) {foreach($this->goals as $i => $item) {
							...
							<tr class="row<?php echo $i % 2; ?>">
								...
								<?php if ($this->canDo->get('core.edit') or ($this->canDo->get('core.edit.own') and $item->user_id == $this->user->get('id'))) { ?>
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=goal.edit&id='.$item->id);?>">
										<?php echo $this->escape($item->title); ?>
									</a>
								<?php } else { ?>
									<?php echo $this->escape($item->title); ?>
								<?php } ?>
								&nbsp;[<a href="<?php echo JRoute::_('index.php?option=com_goals&view=milistones&filter_goals='.$item->id);?>"><?php echo JText::_('COM_GOALS_VIEW_MILESTONES');?></a>]
								</td>
                                <td align="center">
						...
						<?php }} else { ?>
							<tr>
								<td colspan="9" align="center" >
									...
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=goal.add'); ?>" >
