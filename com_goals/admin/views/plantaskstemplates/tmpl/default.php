...
<form action="<?php echo JRoute::_('index.php?option=com_goals&view=plantaskstemplates'); ?>" method="post" name="adminForm" id="adminForm">
				...
				<table class="table table-striped">
						<thead>
							<tr>
								...
								<th width="20%">
									<?php echo JHtml::_('grid.sort', 'COM_GOALS_PERIOD', 'period', $listDirn, $listOrder); ?>
								</th>
								<th class="gl_left">
									<?php echo JHtml::_('grid.sort', 'COM_GOALS_PLANTASK_SELECT', 'gtitle', $listDirn, $listOrder); ?>
								</th>
                                <th>
						...
						<tbody>
						<?php if (sizeof($this->plantasks)) {foreach($this->plantasks as $i => $item) {
							?>
							<tr class="row<?php echo $i % 2; ?>">
								...
								<?php if ($this->canDo->get('core.edit') or ($this->canDo->get('core.edit.own') and $item->user_id == $this->user->get('id'))) { ?>
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=plantaskstemplate.edit&id='.$item->id);?>">
								...
								<td>
									<img src="<?php echo JURI::root();?>administrator/components/com_goals/assets/images/milistones.png" alt="" />
						...
						<?php }} else { ?>
							<tr>
								<td colspan="9" align="center" >
									<?php echo JText::sprintf('COM_GOALS_FIELD_NONE', 'tasks templates'); ?>
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=plantaskstemplate.add'); ?>" >
