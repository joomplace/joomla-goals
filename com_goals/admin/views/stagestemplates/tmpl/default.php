...
<form action="<?php echo JRoute::_('index.php?option=com_goals&view=stagestemplates'); ?>" method="post" name="adminForm" id="adminForm">
				...
				<table class="table table-striped">
						<thead>
							<tr>
								...
								<th class="gl_left">
									<?php echo JHtml::_('grid.sort', 'COM_GOALS_PERIOD', 'dayto', $listDirn, $listOrder); ?>
								</th>
								<th class="gl_left">
									<?php echo JHtml::_('grid.sort', 'COM_GOALS_PLANTEMPLATE_SELECT', 'gtitle', $listDirn, $listOrder); ?>
								</th>	
								<th>
						...
						<tbody>
						<?php if (sizeof($this->stages)) {foreach($this->stages as $i => $item) {
							?>
							<tr class="row<?php echo $i % 2; ?>">
								...
								<?php if ($this->canDo->get('core.edit') or ($this->canDo->get('core.edit.own') and $item->user_id == $this->user->get('id'))) { ?>
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=stagestemplate.edit&id='.$item->id);?>">
								...
								<td>
									...
									<?php echo $item->pttitle; ?>
								</td>
								<td align="center">
									<?php
                                    echo $item->status?JText::_('COM_GOALS_PLANTASK_STATUS_COMPLETED'):JText::_('COM_GOALS_PLANTASK_STATUS_NOT_COMPLETED');
									?>
						...
						<?php }} else { ?>
							<tr>
								<td colspan="9" align="center" >
									<?php echo JText::sprintf('COM_GOALS_FIELD_NONE', 'stages templates'); ?>
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=stagestemplate.add'); ?>" >
