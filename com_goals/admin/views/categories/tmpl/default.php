...
<form action="<?php echo JRoute::_('index.php?option=com_goals&view=categories'); ?>" method="post" name="adminForm" id="adminForm">
				...
				<table class="table table-striped">
						<thead>
							<tr>
								...
								<th width="10%">
									<?php echo JHtml::_('grid.sort', 'COM_GOALS_FIELD_HEADING_DATE', 'date_created', $listDirn, $listOrder); ?>
								</th>								
								<th width="10%">
						...
						<tbody>
						<?php if (sizeof($this->categories)) {foreach($this->categories as $i => $item) {
							?>
							<tr class="row<?php echo $i % 2; ?>">
								...
								<?php if ($this->canDo->get('core.edit') or ($this->canDo->get('core.edit.own') and $item->user_id == $this->user->get('id'))) { ?>
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=category.edit&id='.$item->id);?>">
								...
								<td width="10%">
									<?php echo JHtml::_('date', $item->date_created); ?>
								</td>
								<td width="10%">
									<?php echo JHtml::_('jgrid.published', $item->published, $i, 'categories.', $this->canDo->get('core.edit'), 'cb'); ?>
								</td>								
								<td width="1%">
									<?php echo $item->id; ?>
								</td>
						...
						<?php }} else { ?>
							<tr>
								<td colspan="9" align="center" >
									<?php echo JText::sprintf('COM_GOALS_FIELD_NONE', 'categories'); ?>
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=category.add'); ?>" >
