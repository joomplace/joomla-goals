...
<form action="<?php echo JRoute::_('index.php?option=com_goals&view=stages'); ?>" method="post" name="adminForm" id="adminForm">
				...
				<table class="table table-striped">
						<thead>
							<tr>
								...
								<th class="gl_left">
									<?php echo JHtml::_('grid.sort', 'COM_GOALS_STAGE_PLAN', 'gtitle', $listDirn, $listOrder); ?>
								</th>	
								<th>
						...
						<?php if (sizeof($this->stages)) {foreach($this->stages as $i => $item) {
							...
							<tr class="row<?php echo $i % 2; ?>">
								...
								<?php if ($this->canDo->get('core.edit') or ($this->canDo->get('core.edit.own') and $item->user_id == $this->user->get('id'))) { ?>
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=stage.edit&id='.$item->id);?>">
								...
								<td>
									<?php echo JHtml::_('date',$item->duedate); ?>
								</td>
								<td>
						...
						<?php }} else { ?>
							<tr>
								<td colspan="9" align="center" >
									<?php echo JText::sprintf('COM_GOALS_FIELD_NONE', 'stages'); ?>
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=stage.add'); ?>" >
