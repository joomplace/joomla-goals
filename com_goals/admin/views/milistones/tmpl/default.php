...
<form action="<?php echo JRoute::_('index.php?option=com_goals&view=milistones'); ?>" method="post" name="adminForm" id="adminForm">
						...
						<?php if (sizeof($this->milistones)) {foreach($this->milistones as $i => $item) {
							...
							<tr class="row<?php echo $i % 2; ?>">
								...
								<?php if ($this->canDo->get('core.edit') or ($this->canDo->get('core.edit.own') and $item->user_id == $this->user->get('id'))) { ?>
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=milistone.edit&id='.$item->id);?>">
						...
						<?php }} else { ?>
							<tr>
								<td colspan="9" align="center" >
									...
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=milistone.add'); ?>" >
