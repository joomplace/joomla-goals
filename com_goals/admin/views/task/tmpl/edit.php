...
<script type="text/javascript">
	...
	{
		var url="<?php echo JURI::root()?>administrator/index.php?option=com_goals&task=task.getcustomfields&tmpl=component";
...
<form action="<?php echo JRoute::_('index.php?option=com_goals&view=task&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate form-horizontal" >
	<div class="row-fluid">
	<!-- Begin Content -->
