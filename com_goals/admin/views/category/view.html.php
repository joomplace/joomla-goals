...
class GoalsViewCategory extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
	...
	public function display($tpl = null) 
	{
		...
		$this->custom_cat_fields = GoalsHelper::getCustomCatFields($this->item->id);
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title($isNew ? (JText::_('COM_GOALS').': '.JText::_('COM_GOALS_CATEGORY_CREATING')) : (JText::_('COM_GOALS').': '.JText::_('COM_GOALS_CATEGORY_EDITING')), 'categories');
		if ($isNew) {
