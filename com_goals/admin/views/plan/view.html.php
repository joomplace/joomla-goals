...
class GoalsViewPlan extends JViewLegacy
{
	...
	protected function addToolBar() 
	{
		...
		$isNew = $this->item->id?0:1;

		$canDo = GoalsHelper::getActions();
		JToolBarHelper::title($isNew ? (JText::_('COM_GOALS').': '.JText::_('COM_GOALS_PLAN_CREATING')) : (JText::_('COM_GOALS').': '.JText::_('COM_GOALS_PLAN_EDITING')), 'plans');
		if ($isNew) {
