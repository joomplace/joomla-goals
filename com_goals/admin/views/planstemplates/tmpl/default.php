...
<form action="<?php echo JRoute::_('index.php?option=com_goals&view=planstemplates'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<div class="clearfix"> </div>
				<table class="table table-striped">
						...
						<tbody>
						<?php if (sizeof($this->plans)) {foreach($this->plans as $i => $item) {
							?>
							<tr class="row<?php echo $i % 2; ?>">
								...
								<?php if ($this->canDo->get('core.edit') or ($this->canDo->get('core.edit.own') and $item->user_id == $this->user->get('id'))) { ?>
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=planstemplate.edit&id='.$item->id);?>">
						...
						<?php }} else { ?>
							<tr>
								<td colspan="9" align="center" >
									<?php echo JText::sprintf('COM_GOALS_FIELD_NONE', 'plans templates'); ?>
									<a href="<?php echo JRoute::_('index.php?option=com_goals&task=planstemplate.add'); ?>" >
