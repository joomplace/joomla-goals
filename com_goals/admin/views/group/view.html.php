...
class GoalsViewGroup extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title($isNew ? (JText::_('COM_GOALS').': '.JText::_('COM_GOALS_GROUP_CREATING')) : (JText::_('COM_GOALS').': '.JText::_('COM_GOALS_GROUP_EDITING')), 'custom_groups');
		if ($isNew) {
