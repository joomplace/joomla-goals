...
function change_custom_type(el)
{
 ...
 function rb_cf_del(el)
 {
	...
	{
		if (task == 'userfield.cancel' || document.formvalidator.isValid(document.id('item-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_goals&view=userfield&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate form-horizontal" >
	<div class="row-fluid">
	<!-- Begin Content -->
