...
<script type="text/javascript">
	...
	{
		var url="<?php echo JURI::root()?>administrator/index.php?option=com_goals&task=plantask.getcustomfields&tmpl=component";
	...
	Joomla.submitbutton = function(task) {
		...
		if (task == 'plantask.cancel' || document.formvalidator.isValid(document.id('item-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_goals&view=plantask&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate form-horizontal" >
	<div class="row-fluid">
	<!-- Begin Content -->
