...
$search 	= $this->escape($this->state->get('filter.search_plans'));
$function	= JRequest::getCmd('function', 'jSelectPlan');
?>
				...
				<form action="<?php echo JRoute::_('index.php?option=com_goals&view=plans'); ?>" method="post" name="adminForm" id="adminForm" >
                    ...
                    <fieldset id="filter-bar">
                        <div class="filter-search fltlft">
                            <label class="filter-search-lbl" for="filter_plans">
                                <?php echo JText::_('JSEARCH_FILTER_LABEL'); ?>
                            </label>
                            <input type="text" name="filter_plans" id="filter_plans" value="<?php echo $search; ?>" title="" />
                            <button type="submit">
                                <?php echo JText::_('JSEARCH_FILTER_SUBMIT'); ?>
                            </button>
                            <button type="button" onclick="document.id('filter_plans').value='';this.form.submit();">
