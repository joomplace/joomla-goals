...
<script type="text/javascript">
	...
	{
		if (task == 'milistone.cancel' || document.formvalidator.isValid(document.id('item-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_goals&view=milistone&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate form-horizontal" >
	<div class="row-fluid">
	<!-- Begin Content -->
