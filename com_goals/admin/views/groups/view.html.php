...
class GoalsViewGroups extends JViewLegacy
{
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_GOALS').': '.JText::_('COM_GOALS_MANAGER_GROUPS'), 'custom_groups');
	...
	protected function setDocument() 
	{
		...
		$document->setTitle(JText::_('COM_GOALS').': '.JText::_('COM_GOALS_MANAGER_GROUPS'));
	}
}
